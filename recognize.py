...
classifier = cv2.CascadeClassifier('C:/Users/user/OneDrive/Desktop/Face Detection/Face Detection/haarcascade_frontalface_default.xml')
...
def get_pred_label(pred):
    labels = ["Ayush","Saswat","Swarup","debasish"]
    return labels[pred]
